...
const Footer = () => {
  return (
    <footer className="bg-footer-bg">
      <section className="py-8 lg:lg:py-12 bg-footer-bg">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <ul className="flex justify-center mt-8 gap-6 md:gap-8 sm:justify-start">
              <li>
                <a
                  ...
                  target="_blank"
                  className="text-primary-color transition hover:text-gray-700"
                >
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
            ...
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-gray-900">Hosting</p>
                ...
                <ul className="text-sm space-y-4">
                  ...
                  <li>
                    <a
                      ...
                      href="/"
                    >
                      <span className="text-gray-700 transition group-hover:underline">
                        Live Chat
                      </span>

                      <span className="relative flex w-2 h-2 -mr-2">
                        <span className="absolute inline-flex w-full h-full bg-primary-color rounded-full opacity-75 animate-ping"></span>
                        <span className="relative inline-flex w-2 h-2 bg-primary-color rounded-full"></span>
                      </span>
                    </a>
                  </li>
                </ul>
              ...
              <ul className="mt-8 text-sm space-y-4">
                <li>
                  ...
                  >
                    ...
                    <span className="text-gray-700">info@africar.com</span>
                  </a>
                </li>
        ...
        <div className="pt-6 mt-12 border-t border-gray-200">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-gray-500">
              ...
              &nbsp;
              <a
                className="inline-block text-primary-color underline transition hover:text-gray-700"
                href="/"
              >
                Terms &amp; Conditions
              </a>
    ...
    //     <div className="flex justify-center text-gray-700-600">
    //       <svg
    //         className="h-8"
    //         viewBox="0 0 118 24"
    //         fill="none"
    ...
    //         <li>
    //           <a className="text-gray-700 transition hover:underline" href="/">
    //             About
    //           </a>
    //         </li>
