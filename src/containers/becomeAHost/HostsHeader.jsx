...
const HostsHeader = () => {
  ...
  return (
    <div className="bg-white">
      <section>
        <div className="lg:flex-grow flex flex-col items-center justify-center text-center">
          <h1 className="AfricarTitle1 mb-4">Let your car work for you.</h1>
          <p className="AfricarTitle4 mb-8 leading-relaxed">
            Share your car whenever you’re not using it and earn an average of
            £442 per month* on Africar, Africa’s largest car sharing
            marketplace.
          </p>
          <button
            type="submit"
      ...
      <div className="w-full mt-8">
        <img
          className="object-cover object-top w-full h-96 lg:h-[640px]"
          alt="hero"
          src={smiling}
        />
      </div>
    ...
    //       <h1 className="AfricarTitle1">
    //       Let your car work for you.
    //       </h1>
    //       <p className="mb-8 leading-relaxed">
    //       Share your car whenever you’re not using it and earn an average of £442 per month* on Africar, Africa’s largest car sharing marketplace.
    //       </p>
