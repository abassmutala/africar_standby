...
import crv from "./../assets/crv/2020_honda_cr-v_4dr-suv_touring_fq_oem_1_1600x1067.jpeg"
  ...
  return (
    <div className="bg-gray-100 mt-16">
      ...
      <section className="bg-gray-100">
        <div className="relative w-full flex justify-center items-center max-w-xl mx-auto py-4 md:py-12">
          <input type="text" name="" id="" className="relative w-full" />
          <button className="bg-secondary-color p-2 rounded-lg absolute right-2">
            <MdOutlineSearch className="text-xl text-white" />
          </button>
        </div>

        <main className="">
          <div className="flex items-baseline justify-between border-b border-gray-500 py-6">
          ...
          <div aria-labelledby="products-heading" className="pt-6 pb-16">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3 xl:grid-cols-4">
              <form className="hidden lg:block bg-white px-8 py-4 h-min">
                {filters.map((section) => (
                  <div
                    key={section.id}
                  ...
                  >
                    <div className="w-full">
                      <h6 className="AfricarTitle5">{section.name}</h6>
                    </div>
                    <div className="pt-6">
                ...
                {isGrid ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8">
                    {cars.map((car, index) => (
                      <div
                        id={index}
                        className="bg-white rounded-md w-full truncate cursor-pointer"// h-[400px] md:h-[340px] xl:h-[360px]
                        onClick={() =>
                          navigate(`/car/${car.make}/${car.model}/${index + 1}`)
                        }
                      >
                        <div className="flex flex-col">
                          <div className="w-full aspect-video object-cover object-center overflow-hidden">
                            <img
                              src={car.photo}
                              alt={car.model}
                              // width={350}
                              // height={160}
                              className="w-full object-cover overflow-hidden bg-white rounded-t-md"
                            />
                          </div>
                          <div className="p-4">
                            <h6 className="AfricarTitle5 font-bold truncate">
                              {car.make} {car.model}
                            </h6>
                            <p>{car.year}</p>
                            <div className="pt-4 grid grid-cols-3 gap-x-2 text-md lg:text-lg text-gray-500 truncate">
                              <div className="w-full flex flex-row items-center space-x-1 text-lg">
                                <MdPersonOutline />
                                <span className="truncate">{car.seats}</span>
                              </div>
                              <div className="w-full flex flex-row items-center space-x-1 text-lg">
                                <MdOutlineLocalGasStation />
                                <span className="truncate">4L</span>
                              </div>
                              <div className="w-full flex flex-row items-center space-x-1 text-lg">
                                <MdOutlineSettings />
                            ...
                            <div className="flex flex-row items-center justify-between pt-4">
                              <h6 className="AfricarTitle4 truncate">
                                ${car.pricePerDay}
                                <sub className=" text-gray-500">/day</sub>
                              </h6>
                              <button
                                type="submit"
                                className="btn-sm btn-elevated bg-secondary-color ring-secondary-color"
                              >
          ...
          <div className="flex items-center justify-center space-x-8 text-4xl">
            <div className="p-2 bg-primary-color text-white">
              <MdOutlineChevronLeft />
            </div>
            <div>
              <h5 className="h6 AfricarTitle5 font-b">1/3</h5>
            </div>
            <div className="p-2 bg-primary-color text-white">
              <MdOutlineChevronRight />
            </div>
